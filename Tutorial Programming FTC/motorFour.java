...
@Disabled
public class motorFour extends LinearOpMode
{
    ...
    private void initMotorFour() {
        ...
        motorFour.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER); // The encoder's current position is set as zero
    ...
    public void motorFourMaxVelocityTest() {
        ...
        currentVelocity = motorFour.getVelocity(); // ticks per second
